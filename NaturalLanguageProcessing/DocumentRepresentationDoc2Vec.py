...
class DocumentRepresentationDoc2Vec:
    ...
    def concatBothParagraphVectors(self, vector_size = 100, window_size = 10, dm_mean = 1, dm_concat = 0):
        returnValue = []
        representation01 = Doc2Vec(self.documents, vector_size=vector_size/2, window=window_size, workers=4, dm_mean=dm_mean, dm_concat=dm_concat, dm=0)
        representation02 = Doc2Vec(self.documents, vector_size=vector_size/2, window=window_size, workers=4, dm_mean=dm_mean, dm_concat=dm_concat, dm=1)
